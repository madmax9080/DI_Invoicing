...
class InvoiceItem(Base):
    ...
    uomId = Column(String(50), nullable=True)
    uom = Column(String(50), nullable=False)
    quantity = Column(Numeric(15, 4), nullable=False)
    rateId = Column(String(50), nullable=True)
    ...
    sroId = Column(String(50), nullable=True)
    sroScheduleNo = Column(String(50), nullable=True)
    sroItemId = Column(String(50), nullable=True)
    sroItemSerialNo = Column(String(50), nullable=True)
    saleTypeId = Column(String(50), nullable=True)
